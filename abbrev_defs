...
(define-abbrev-table 'cperl-mode-abbrev-table
  '(
    ...
    ("else" "else" cperl-electric-else :count 1)
    ...
    ("head2" "head2" cperl-electric-pod :count 0)
    ("if" "if" cperl-electric-keyword :count 8)
    ("over" "over" cperl-electric-pod :count 0)
    ("pod" "pod" cperl-electric-pod :count 2)
    ("unless" "unless" cperl-electric-keyword :count 1)
    ("until" "until" cperl-electric-keyword :count 3)
    ("while" "while" cperl-electric-keyword :count 1)
   ))
...
(interactive)
    ...
    ("eg" "e.g." nil :count 0)
    ("envirionment" "environment" nil :count 0)
    ...
    ("heikkil" "Heikki Lehväslaiho" nil :count 7)
...
" nil :count 5)
    ...
    ("olatex" "#+LATEX_HEADER:
ewcommand{myvar}{myvalue}" nil :count 0)
    ("oname" "#+NAME:" nil :count 14)
...
# Time-stamp: \" \"" nil :count 2)
    ...
    ("ouml" "@startuml
@enduml" nil :count 2)
    ("owid" "#+attr_org: :width 100" nil :count 1)
